...
LIST_FILE = ft_lstadd.c ft_lstaddapha.c ft_lstaddend.c ft_lstaddnew.c ft_lstdel.c ft_lstdelall.c ft_lstdelone.c ft_lstdelonejoin.c ft_lstiter.c ft_lstiter_reverse.c ft_lstmap.c ft_lstnew.c
...
PRINT_CHAR_FILE = ft_putchar.c ft_putchar_fd.c ft_putcharl.c ft_putcharl_fd.c ft_putchars.c ft_putwchar.c ft_putwcharl.c ft_putwchars.c ft_putwnchar.c ft_putxchar.c ft_putxwchar.c
