...
#    Updated: 2017/06/06 17:43:44 by aguerin          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(CHR)ft_putchar.c $(CHR)ft_putchar_fd.c $(CHR)ft_putcharl.c $(CHR)ft_putchars.c $(STR)ft_putendl.c $(STR)ft_putendl_fd.c $(NBR)ft_putnbr.c $(NBR)ft_putnbr_fd.c $(NBR)ft_putnbr_long.c $(NBR)ft_putnbrl.c $(NBR)ft_putnbrs.c $(STR)ft_putnstr.c $(STR)ft_putstr.c $(STR)ft_putstrlower.c $(STR)ft_putstr_fd.c $(STR)ft_putstrs.c $(STR)ft_putstrupper.c $(CHR)ft_putwchar.c $(CHR)ft_putwcharl.c $(CHR)ft_putwchars.c $(STR)ft_putwendl.c $(CHR)ft_putwnchar.c $(STR)ft_putwstr.c $(STR)ft_putwstrs.c $(CHR)ft_putxchar.c $(CHR)ft_putxwchar.c $(CHR)ft_putcharl_fd.c\
$(SRC)ft_swap.c $(SRC)get_next_line.c $(STR)ft_perror.c\
$(STRING)ft_nbrlen.c $(STRING)ft_strwbytlen.c $(STRING)ft_count_word.c $(STRING)ft_strcat.c $(STRING)ft_strchr.c $(STRING)ft_strclr.c $(STRING)ft_strcmp.c $(STRING)ft_strcpy.c $(STRING)ft_strdup.c $(STRING)ft_strequ.c $(STRING)ft_strjoin.c $(STRING)ft_strlcat.c $(STRING)ft_strlen.c $(STRING)ft_strmap.c $(STRING)ft_strmapi.c $(STRING)ft_strncat.c $(STRING)ft_strncmp.c $(STRING)ft_strncpy.c $(STRING)ft_strnequ.c $(STRING)ft_strnstr.c $(STRING)ft_strrchr.c $(STRING)ft_strsplit.c $(STRING)ft_strstr.c $(STRING)ft_strsub.c $(STRING)ft_strtolower.c $(STRING)ft_strtoupper.c $(STRING)ft_strtrim.c $(STRING)ft_strwlen.c\
$(TAB)fill_tab.c\
\
