...
ft_memalloc.c ft_memdel.c ft_strnew.c ft_strdel.c ft_strclr.c ft_striter.c ft_striteri.c ft_strmap.c ft_strmapi.c ft_strequ.c ft_strnequ.c ft_strsub.c ft_strjoin.c ft_strtrim.c ft_strsplit.c ft_itoa.c\
ft_lstnew.c ft_lstdelone.c ft_lstdel.c ft_lstadd.c ft_lstiter.c ft_lstmap.c\
ft_swap.c ft_count_word.c ft_lstdelonejoin.c ft_strfreejoin.c ft_lstaddend.c ft_lstaddnew.c ft_lstdelall.c ft_itoa_base.c ft_itoa_long.c ft_atoi_base.c get_next_line.c\
