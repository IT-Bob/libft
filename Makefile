...
MEM_FILE = ft_bzero.c ft_memalloc.c ft_memrealloc.c ft_memccpy.c ft_memchr.c ft_memcmp.c ft_memcpy.c ft_memdel.c ft_memmove.c ft_memset.c ft_strdel.c ft_strdeldouble.c ft_strfreejoin.c ft_striter.c ft_striteri.c ft_strnew.c
